...
description: >
                                        Parsa is a popular HTML theme offered by ThemeFisher.
                                        I have Jekyllised this theme to give web developers and
                                        hobbyists a simple and clean implimentation in Jekyll
                                        for starting new sites.
                                        <br/><br/>
                                        This template is <b>free and open source</b>, released
...
resources:                              [ animate, clipboard, rouge, toccer ]
resource_options:
  - toccer:
      collapseDepth:                    3
---
