...
Then:
  ...
  git commit -am "New version v2023.0.17"
  git commit --allow-empty -m "New version v2023.0.17"
  git commit -am "Prepare new version v2023.0.17"
  git commit -am "Latest files of version v2023.0.17"
